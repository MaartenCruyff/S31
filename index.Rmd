...
- [`pics/code.png`](1A-Data Visualization/pics/code.png){target="_blank"} 
...
- [`novels.Rdata`](4A-PCA/novels.Rdata)
...
- [Lecture sheets](5A Neural Net/Neural_Net.html){target="_blank"}

- [Ioslide Lecture Rmd file](5A Neural Net/Neural_Net.Rmd){target="_blank"}


**Recommended literature**

- [Deep Learning with R](https://livebook.manning.com/book/deep-learning-with-r/about-this-book/){target="_blank"}

- [Deep Learning](https://www.deeplearningbook.org/){target="_blank"}
